...
export async function main() {
	...
	// request from the endpoint with the query parameters
	//axios.get(endpoint, { params: queryParameters })
	...
	//request.open('GET', endpoint + '?' + new URLSearchParams(queryParameters), false);
	//request.send(null);
